...
`GetProjectionMatrix` on this Freedom path. AVP validation remains blocked by
issue #42, not by #38.

## Next Action

Move to #42 and fix or classify the AVP emitted-frame transport failure before
the next AVP visual test.
